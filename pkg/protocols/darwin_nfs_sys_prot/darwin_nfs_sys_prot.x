package "github.com/buildbarn/go-xdr/pkg/protocols/darwin_nfs_sys_prot";

import "pkg/protocols/nfsv4/nfsv4.x";
...
typedef string			nfs_mattr_mntfrom<1023>;
typedef string			nfs_mattr_realm<1023>;
typedef string			nfs_mattr_principal<1023>;
typedef string			nfs_mattr_svcpinc<1023>;
